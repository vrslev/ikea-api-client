...
class _Measurements(BaseModel):
    referenceMeasurements: list[_ReferenceMeasurements]
...
def get_name(comm: _LocalisedCommunication):
    ...
    item_name: str = comm.productName
    ...
    measurements = comm.measurements.referenceMeasurements
    measurement_text: str | None = measurements[0].metric if measurements else None
    comm.productType.name = comm.productType.name.capitalize()

    return ", ".join(
        part
        for part in (
            item_name,
            comm.productType.name,
            comm.validDesign.text,
            measurement_text,
        )
        if part
    )
            ...
            "localisedCommunications": [
                {
                    ...
                    "measurements": {
                        "referenceMeasurements": [
                            {"metric": "77x147 cm", "imperial": '30 3/8x57 7/8 "'}
                        ],
                    ...
                    "fullLengthTexts": {
                        ...
                        "texts": [
                            {"id": "Name", "value": "Wood"},
                            {"id": "Main Headline", "value": "Our take on wood"},
                            {
                                "id": "Introduction",
                    ...
                    "filterInformation": {
                        ...
                        "classFilters": [
                            ...
                            },
                            {
                                ...
                                "name": "Material",
                                "values": [
                                    {"id": "47349", "name": "Wood (including board)"}
                                ],
                            },
                            {
                                "id": "47352",
                                "name": "Features",
                                "values": [{"id": "53039", "name": "With shelves"}],
                            },
                            {
                                "id": "47688",
                                "name": "Doors",
                                "values": [{"id": "47687", "name": "Without doors"}],
                            },
                        ],
                    },
                ...
                },
                {
                    ...
                    "measurements": {
                        "referenceMeasurements": [
                            {"metric": "77x147 см", "imperial": "30 3/8x57 7/8 дюйм"}
                        ],
                        "detailedMeasurements": [
                            {
                                "type": "00047",
                    ...
                    "filterInformation": {
                        ...
                        "classFilters": [
                            ...
                            },
                            {
                                ...
                                "name": "Материал",
                                "values": [
                                    {"id": "47349", "name": "Древесина (в т. ч. доска)"}
                                ],
                            },
                            {
                                "id": "47352",
                                "name": "Свойства",
                                "values": [{"id": "53039", "name": "С полками"}],
                            },
                            {
                                "id": "47688",
                                "name": "Дверцы",
                                "values": [{"id": "47687", "name": "Без дверей"}],
                            },
                        ],
                    },
    ...
    "data": [
        {
            ...
            "localisedCommunications": [
                {
                    ...
                    "materials": [
                        ...
                        },
                        {
                            ...
                            "partMaterials": [{"materialText": "Galvanized steel"}],
                        },
                    ],
                    "environmentTexts": [
                        {
                ...
                },
                {
                    ...
                    "materials": [
                        ...
                        },
                        {
                            ...
                            "partMaterials": [{"materialText": "Оцинкованная сталь"}],
                        },
                    ],
                    "environmentTexts": [
                        {
            ...
            "news": {"value": True, "validFrom": "2021-10-26", "validTo": "2022-02-23"},
            "catalogueReferences": [{"catalogueId": "products", "categoryId": "55015"}],
            "lastChance": {"value": False},
            "professionalAssemblyTime": {"value": 72, "unit": "MINUTES"},
            "genericProduct": {"gprNo": "37968"},
            "productTags": [
                {"name": "NEW", "validFrom": "2021-10-26", "validTo": "2022-02-23"}
            ],
        }
    ]
}
if __name__ == "__main__":
    print(list(main(valid_dict)), list(main(combination)))
